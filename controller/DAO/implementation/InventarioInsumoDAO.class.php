...
require_once($_SERVER['DOCUMENT_ROOT'].'/erpbienesyservicios/model/InventarioInsumo.class.php');
require_once($_SERVER['DOCUMENT_ROOT'].'/erpbienesyservicios/controller/DAO/interfaces/iInventarioInsumoDAO.interface.php');
